...
Model_And_Embedder = BasicUtils(['grok-3', 'gpt-4.1-mini', 'gpt-4.1-nano'],disable_language_model)
model = Model_And_Embedder.model_list['gpt-4.1-mini']
model_high=Model_And_Embedder.model_list['grok-3']
...
def main():
    ...
    result_dir = "result/exp_llm/grok"  # New directory for team composition results
